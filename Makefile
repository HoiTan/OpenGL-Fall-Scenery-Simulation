...
FinalProject:		FinalProject.cpp
		g++ -framework OpenGL -framework GLUT FinalProject.cpp -o FinalProject -Wno-deprecated
		# g++ -framework OpenGL -framework GLUT FinalProject.cpp -o FinalProject -I. -Wno-deprecated
		# g++ -std=c++17  -framework OpenGL -framework GLUT FinalProject.cpp TreeBody/LSystem.cpp TreeBody/Turtle.cpp -o FinalProject -Wno-deprecated
